...
function DateFilter() {
    ...
    return (
          <div className="flex gap-3 bg-active  text-lg px-2 py-1 mx-2  font-semibold rounded-lg shadow-activeBorder shadow-md ">
                ...
                <button className="hover:bg-activeBorder hover:text-white px-2 rounded-lg focus:bg-activeBorder focus:text-white" onClick={() => handleClick('alreadyExpired')}>Expired</button>
